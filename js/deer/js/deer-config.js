...
export default {
    ...
    PRIMITIVES: ["name", "creator", "label", "date", "location","startDate","endDate"],
    ...
    EVENTS: {
        ...
        NEW_VIEW: namespace+"-view",
        NEW_FORM: namespace+"-form",
        VIEW_RENDERED: namespace+"-view-rendered",
        FORM_RENDERED: namespace+"-form-rendered",
