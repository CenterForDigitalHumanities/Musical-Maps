...
const {default:DEER} = await import('./deer-config.js').catch(e=>import('/js/deer/js/deer-config.js'))

if('undefined' !== typeof window) {
    window.DEERWorker = window.DEERWorker ?? new Worker('js/deer/js/worker.js', { type: 'module' })
}
const worker = ('undefined' !== typeof WorkerGlobalScope) ? undefined : window?.DEERWorker ?? new Worker('/js/deer/js/worker.js', { type: 'module' })
